...
31. [A very interesting article](https://glazkov.com/2008/01/31/gears-asp-net-tutorial/) written by the same guy, Dimitri Glazkov, about Google Gears, a project which I believe may have been subsumed by a newer name. I believe so because the link he offers to the Google Gears website leads nowhere but to a general landing page on Google. This article is about integrating Google Gears with ASP.NET. From a very cursory reading of the first few paragraphs of the article, it looks like he's talking about offline apps that have the ability to sync data with the server later on. They probably use HTML5 local storage or Webstorage or some such.
32. A nice, perhaps old [JavaScript language reference](https://docs.oracle.com/cd/E19957-01/816-6408-10/) on the Oracle website. I got to it following the links in the **JavaScript bindings** section of the KJS html document.
33. My StackOverflow question titled, ["How do web browser engines work to render web pages?"](https://stackoverflow.com/q/48852209/303685).
